...
<div class="w3-main" style="margin-left:300px;margin-right:40px">
    ...
    <div class="w3-container" style="margin-top:50px" id="registration">
        <h1 class="w3-xxxlarge w3-text-green"><b>Add Company</b></h1>
        <hr style="width:50px;border:5px solid green" class="w3-round">
        <p>Fill out the form below to add new company.</p>
        <form method="POST">
...
if (isset($_POST['Register'])) {
    ...
    if (mysqli_num_rows($check_email) > 0) {
        ...
        $query = mysqli_query($connect, "INSERT INTO users (name, number, email, password, user_type) 
        VALUES ('$name', '$number', '$email', '$password', '$user_type')");
        ...
        if ($query) {
            echo '<script>
                 ...
                 echo "<script> setTimeout(function(){ window.location.href = 'adminCompany.php'; }, 1000); </script>";
