...
<div class="w3-main" style="margin-left:300px;margin-right:40px; min-height:70vh">
    ...
    <div class="w3-container" id="myQuotes" style="margin-top: 40px">
        <h1 class="w3-xxlarge w3-text-green"><b>ALL COMPANIES</b></h1>
        <a href="addCompany.php" class="btn btn-success"><b>Add Company</b></a>
        ...
        <div class="table-responsive">
            <table class="w3-table-all">
                ...
                $query = "SELECT * from users WHERE user_type = 'Company' ORDER BY user_id DESC;
                ";
